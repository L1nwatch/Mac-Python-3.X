...
class TestConfigReader(unittest.TestCase):
    ...
    def test_read_mysql_info(self):
        ...
        测试读取 mysql 信息
        """
        db_host, db_user, db_password, db_name = self.test_cr.read_mysql_info(self.test_file_path)
    ...
    def test_read_af_info(self):
        ...
        测试读取 af 信息
        """
        af_ip, af_port, af_back_user, af_back_password = self.test_cr.read_af_back_info(self.test_file_path)
    ...
    def test_read_ip_info(self):
        ...
        测试读取 ip 信息
        """
        local_ip, target_ip = self.test_cr.read_ip_info(self.test_file_path)
    ...
    def test_read_des_info(self):
        ...
        测试读取 des 相关信息
        """
        des_key, des_iv = self.test_cr.read_des_info(self.test_file_path)
    ...
    def test_read_lib_info(self):
        ...
        测试读取 lib 相关信息
        """
        lib, waf_ips, utm = self.test_cr.read_lib_info(self.test_file_path)
