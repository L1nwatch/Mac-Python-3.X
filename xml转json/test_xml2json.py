...
"""
import unittest
from  xml2json import parse_doc_to_dict, get_docs_from_file
...
"""
        right_answer = {"url": "http://news.sohu.com/20120612/n345428229.shtml",
                        ...
                        "content_title": "公安机关销毁１０余万非法枪支　跨国武器走私渐起",
...
<content>新华网仰光６月１２日电（记者张云飞）实行紧急状态的缅甸西部若开邦１２日虽然仍有零星骚乱发生，但局势总体已得到控制。据官方最新统计，自８日在若开邦孟都等地区实行宵禁至１１日，共有２１人在骚乱中死亡，２１人受伤，１６６２间房屋被烧。１２日上午，位于若开邦首府实兑的纳西市场遭纵火。此外，实兑附近农村也有几处房屋被烧。军警在努力恢复当地秩序的同时，还为临时救助站的难民提供救济物资。目前，在孟都和布帝洞地区共有８个临时救助站，其中有两处专门用来安置穆斯林难民。此次骚乱的直接原因是近日发生的两起杀人案，激化了不同民族和宗教之间的对立。缅甸中央政府已于６日成立专门调查委员会，并从８日开始在若开邦部分地区实行宵禁，白天则禁止５人以上在公共场合集会。１０日，缅甸总统吴登盛签署法令宣布在若开邦立即实行紧急状态，以防止骚乱事态进一步扩大蔓延。</content>
</doc>
"""
        self.assertIn(right_data, parse_result)
