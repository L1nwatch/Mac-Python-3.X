...
class FunctionalTestATMScrapy(unittest.TestCase):
    ...
    def test_can_get_all_dir_name(self):
        ...
        """
        # Y 运行了这个工具
        self.test_atm_crawl.crawl(self.test_project_id, os.curdir)
    ...
    def test_can_parse_dir_tree(self):
        ...
        self.assertTrue(all(os.path.exists(os.path.join(os.curdir, next_dir)) for next_dir in page_parent_dirs))
    ...
    def test_can_get_all_content(self):
        ...
        file_path = os.path.join(os.curdir, "必选发布测试项new", "发布测试项", "前置", "新需求-区域-勾我")
